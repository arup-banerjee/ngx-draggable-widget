...
export function main() {
	describe("NgWidgetContainer Directive", () => {
		it("should initialise element styles and config ngOnInit", () => {
			...
			var ngGrid = new NgWidgetContainer(null, null, renderSpy, null,null);
		...
		it("should set dragEnable to the relevant value on enable/disable drag", () => {
			var ngGrid = new NgWidgetContainer(null, null, null, null);
		...
		it("should fix collisions with other items", ()=> {
			...
			var ngGrid = new NgWidgetContainer(null, null, renderSpy, null);
			var item1 = new NgWidget(null, renderSpy, ngGrid);
			var item2 = new NgWidget(null, renderSpy, ngGrid);
			var item3 = new NgWidget(null, renderSpy, ngGrid);
			var item4 = new NgWidget(null, renderSpy, ngGrid);
