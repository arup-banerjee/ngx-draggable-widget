import { NgWidgetContainer, NgWidget } from '../dist/NgWidgetContainer';

export function main() {
	describe("NgWidget Directive", () => {
		it("should generate a ngGrid item", () => {
			var ngGridItem: NgWidget = new NgWidget(null, null, null);
		});
		...
		it("should set the element class on init", () => {
			...
			var ngGridItem: NgWidget = new NgWidget(ngEl, renderSpy, ngGrid);
		...
		it("should remove the item", () => {
			...
			var ngGridItem: NgWidget = new NgWidget(null, null, ngGridSpy);
		...
		it("should set the dimensions", () => {
			var renderSpy = jasmine.createSpyObj('renderSpy', ['setElementStyle']);
			var ngEl: any = {};
			var ngGridItem: NgWidget = new NgWidget(ngEl, renderSpy, null);
			var newWidth = 31;
			var newHeight = 27;
		...
		it("should recalculate the position", () => {
			...
			var ngGridItem: NgWidget = new NgWidget(null, null, ngGrid);
		...
		it("should add moving class and styles on startMoving", () => {
			...
			var ngGridItem: NgWidget = new NgWidget(elem, renderSpy, ngGrid);
		...
		it("should attempt to calculate the mouse position", () => {
			...
			var ngGridItem: NgWidget = new NgWidget(elem, null, null);
